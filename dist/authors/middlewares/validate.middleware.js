...
var ValidateMiddleware = /** @class */ (function () {
    ...
    ValidateMiddleware.checkForExistence = function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
        var authorId, repository, author, e_1;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    author = _b.sent();
                    if (!author) {
                        return [2 /*return*/, response.send({ status: 404, message: 'User not found' })];
                    }
                    else {
                        next();
                    }
    ...
    ValidateMiddleware.validateNameUpdate = function (request, response, next) {
        var schema = Joi.object({
            name: Joi.string().required(),
        });
        var result = schema.validate(request.body, { abortEarly: true });
